package br.com.cleo.escolaebd.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.com.cleo.escolaebd.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.com.cleo.escolaebd.repository.UserRepository.USERS_BY_EMAIL_CACHE);
