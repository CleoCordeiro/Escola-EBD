...
/**
 * Service Interface for managing {@link br.com.cleo.escolaebd.domain.Pessoa}.
 */
public interface PessoaService {
     ...
     * @return the list of entities.
     */
    Page<PessoaDTO> findAllWithEagerRelationships(Pageable pageable);
     ...
     * @return the entity.
     */
    Optional<PessoaDTO> findOne(UUID id);
