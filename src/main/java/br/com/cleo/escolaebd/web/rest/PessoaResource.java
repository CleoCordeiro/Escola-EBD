...
import br.com.cleo.escolaebd.service.PessoaQueryService;
...
/**
 * REST controller for managing {@link br.com.cleo.escolaebd.domain.Pessoa}.
 */
@RestController
@RequestMapping("/api")
public class PessoaResource {
    ...
    public ResponseEntity<PessoaDTO> getPessoa(@PathVariable UUID id) {
