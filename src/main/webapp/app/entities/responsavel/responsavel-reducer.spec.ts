...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESPONSAVEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESPONSAVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESPONSAVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESPONSAVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESPONSAVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESPONSAVEL actions', async () => {
      const expectedActions = [
        {
