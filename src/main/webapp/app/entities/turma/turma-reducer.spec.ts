...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './turma.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TURMA_LIST actions', async () => {
    ...
    it('dispatches FETCH_TURMA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TURMA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TURMA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TURMA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TURMA actions', async () => {
      const expectedActions = [
        {
